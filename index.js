...
var main = function () {
    ...
    parser.option('createSymlink', {
        flag: true,
        abbr: 'ln',
        help: 'will create symlink in install directory and store dependencies uncompressed. This requires more disk' +
        ' space but extremely increases performance'
    });
    ...
    parser.option('version', {
        ...
        callback: function () {
            ...
            var packageParsed = JSON.parse(packageFile.toString());
    ...
    var examples = [
        ...
        '\tnpm-cache install --createSymlink npm\t# do not compress/archive the cached dependencies and make symlink' +
...
var installDependencies = function (opts) {
    ...
    async.each(
        ...
        function startManager(managerName, callback) {
            ...
            managerConfig.noArchive = opts.noArchive || opts.createSymlink;
            managerConfig.createSymlink = opts.createSymlink;
